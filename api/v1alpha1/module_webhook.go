...
//+kubebuilder:webhook:path=/validate-ooto-sigs-k8s-io-v1alpha1-module,mutating=false,failurePolicy=fail,sideEffects=None,groups=ooto.sigs.k8s.io,resources=modules,verbs=create;update,versions=v1alpha1,name=vmodule.kb.io,admissionReviewVersions=v1
